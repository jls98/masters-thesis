...
// IntelGen12 e core
#define THRESHOLD_SINGLE_L1D_E12 44      // ~2.2/ 61<60 on single measurement / new 200? 140-180, 38-42 for L1?
...
#define reps 100000 // weird effects when increasing repetitions -> rapid increase of measured times per iteration
static int64_t test1(void *addr, uint64_t size, void* cand, uint64_t threshold){    
    if (size==0 || addr==NULL || cand==NULL) return -1; // parameter check
