...
static inline Config * initConfig(u64 cache_ways, u64 pagesize, u64 cache_sets, u64 cacheline_size, u64 threshold_L1, u64 threshold_L2, u64 threshold_L3){
...
// struct Target 
static inline Target *initTarget(void *target_adrs){
	if (target_adrs == NULL){
...
// struct Eviction_Set
static inline Eviction_Set * initEviction_Set(Target *target, Config *conf){
	if (target == NULL){
...
static inline void freeEviction_Set (Eviction_Set *evset){
